...
class _FAQState extends State<FAQ> {
  List<Item> items = [
    ...
    Item(
        ...
        "หากมีข้อสงสัยเกี่ยวกับการใช้งานผลิตภัณฑ์สามารถติดต่อสอบถามรายละเอียดเพิ่มเติมได้ที่ info@thewiseworks.com",
        false),
    Item(
        // 12,
        "สนใจผลิตภัณฑ์ wisework จะขอทดลองใช้งานได้อย่างไร",
        "หากสนใจ wisework และต้องการสอบถามรายละเอียดเกี่ยวกับผลิตภัณฑ์หรือทดลองใช้งาน สามารถติดต่อผ่านทางอีเมล์ info@thewiseworks.com โดยทางเจ้าหน้าที่จะติดต่อกลับโดยเร็วที่สุดเพื่อขอข้อมูลเพิ่มเติมเพื่อแนะนำ solutions ที่เหมาะสมที่สุดสำหรับธุรกิจของคุณ",
        false),
  ];
